...
def _evaluate(eval_fn, input_fn, decode_fn, path, config):
    ...
    with graph.as_default():
        ...
        placeholders = {
            ...
            "context_lan_src": tf.placeholder(tf.int32, [None, None], "context_lan_src"),
            "context_lan_src_length": tf.placeholder(tf.int32, [None], "context_lan_src_length"),
            "context_lan_tgt": tf.placeholder(tf.int32, [None, None], "context_lan_tgt"),
            "context_lan_tgt_length": tf.placeholder(tf.int32, [None], "context_lan_tgt_length"),
            "emotion": tf.placeholder(tf.int32, [None, None], "emotion"),
            ...
            "position_lan_src": tf.placeholder(tf.int32, [None, None], "position_lan_src"),
            "position_lan_tgt": tf.placeholder(tf.int32, [None, None], "position_lan_tgt"),
        ...
        with tf.train.MonitoredSession(session_creator=sess_creator) as sess:
            while not sess.should_stop():
                ...
                outputs = sess.run(predictions, feed_dict={
                    ...
                    placeholders["context_lan_src"]: feats["context_lan_src"],
                    placeholders["context_lan_tgt"]: feats["context_lan_tgt"],
                    ...
                    placeholders["context_lan_src_length"]: feats["context_lan_src_length"],
                    placeholders["context_lan_tgt_length"]: feats["context_lan_tgt_length"],
                    placeholders["emotion"]: feats["emotion"],
                    ...
                    placeholders["position_lan_src"]: feats["position_lan_src"],
                    placeholders["position_lan_tgt"]: feats["position_lan_tgt"],
