...
#        features_ctx = dataset.get_inference_input(sorted_ctxs, params)
        ...
        features_ctxs4 = dataset.get_inference_input(pos_tgt_sty, "pos", params)
        ...
        features["context_sty_src"] = features_ctxs1["source"]
        features["context_sty_src_length"] = features_ctxs1["source_length"]
        features["position_sty_src"] = features_ctxs2["source"]
        features["context_sty_tgt"] = features_ctxs3["source"]
        features["context_sty_tgt_length"] = features_ctxs3["source_length"]
        features["position_sty_tgt"] = features_ctxs4["source"]
